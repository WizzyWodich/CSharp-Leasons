...
{ 
    ...
    class Program
    {
        ...
        {
            int variable; // Переменная обявленная но не инициализированая.
            int variable_2 = 102; // Переменная обявленная и инициализирована числом.
            ...
            var a = 10; /* var это тип данных который автоматически определяет тип данных переменной (если переменная содержит строку будет тип string и т.д)
                        ...
                        * Выделение памяти - ?
                        */
            // var Var; Неявно типизирован должен быть сразу объявленным.
            ...
            // Типы данных с плавоющей точкой:
            ...
            decimal n9 = 1005.8M; // Хранит десятичное дробное число. Если употребляется без десятичной запятой, имеет значение от ±1.0*10-28 до ±7.9228*1028,
            ...
            /* Что жетакое .NET - Boolean? Определение или то как записан (называеться) тип данных в ДотНЭТ то есть 
             * bool = System.Boolean это больше заметно когда используенться конвертирование в определенный тип данных. Так как C# воспринимает все 
             * в строках.
             */

            /* Суффиксы - При присвоении значений надо иметь в виду следующую тонкость: все вещественные литералы 
             ...
             * Подобным образом все целочисленные литералы рассматриваются как значения типа int. Чтобы явным образом указать, что 
             * целочисленный литерал представляет значение типа uint, надо использовать суффикс U/u, для типа long - суффикс L/l, 
